...
| Property | Value |
|----------|-------|
| Endpoint | `POST https://app-bcu5qckc6vb5-api-W9z3M6eONl3L.gateway.appmedo.com/parse/image` |
...
async function ocrParseImage(params: {
  ...
  const response = await fetch("https://app-bcu5qckc6vb5-api-W9z3M6eONl3L.gateway.appmedo.com/parse/image", {
    method: "POST",
    headers: {
...
serve(async (req: Request): Promise<Response> => {
  ...
  // --- Call upstream ---
  const upstream = await fetch("https://app-bcu5qckc6vb5-api-W9z3M6eONl3L.gateway.appmedo.com/parse/image", {
    method: "POST",
    headers: {
